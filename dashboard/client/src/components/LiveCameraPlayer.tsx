...
import { Camera, Square, Circle, Wifi, Radio, Zap, Shield } from 'lucide-react';

const CHUNK_DURATION_MS = 5000; // 5 seconds per chunk

const LiveCameraPlayer: React.FC = () => {
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-slate-500 max-w-xs">
              Allow browser camera access to start real-time threat analysis. Video is split into 5-second chunks and analyzed by the VLM model.
            </p>
          </div>
...
export default LiveCameraPlayer;
